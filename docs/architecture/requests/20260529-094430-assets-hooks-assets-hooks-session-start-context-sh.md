# Architecture Drift Request: 20260529-094430-assets-hooks-assets-hooks-session-start-context-sh

> **Status**: Pending
> **Detected**: 2026-05-29T09:44:30+0800
> **Severity**: high
> **Change Type**: workflow-surface
> **File**: `assets/hooks/session-start-context.sh`
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block "assets/hooks" --request "docs/architecture/requests/20260529-094430-assets-hooks-assets-hooks-session-start-context-sh.md"`.
...
```json
{
  "ts": "2026-05-29T09:44:30+0800",
  "file_path": "assets/hooks/session-start-context.sh",
  "severity": "high",
  ...
  "request_file": "docs/architecture/requests/20260529-094430-assets-hooks-assets-hooks-session-start-context-sh.md",
