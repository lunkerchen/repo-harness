# Architecture Drift Request: 20260528-222444-ai-hooks-ai-hooks-pre-edit-guard-sh

> **Status**: Pending
> **Detected**: 2026-05-28T22:24:44+0800
> **Severity**: high
> **Change Type**: workflow-surface
> **File**: `.ai/hooks/pre-edit-guard.sh`
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block ".ai/hooks" --request "docs/architecture/requests/20260528-222444-ai-hooks-ai-hooks-pre-edit-guard-sh.md"`.
...
```json
{
  "ts": "2026-05-28T22:24:44+0800",
  "file_path": ".ai/hooks/pre-edit-guard.sh",
  "severity": "high",
  ...
  "request_file": "docs/architecture/requests/20260528-222444-ai-hooks-ai-hooks-pre-edit-guard-sh.md",
