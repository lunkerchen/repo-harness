# Architecture Drift Request: 20260528-222705-ai-hooks-ai-hooks-worktree-guard-sh

> **Status**: Pending
> **Detected**: 2026-05-28T22:27:05+0800
> **Severity**: high
> **Change Type**: workflow-surface
> **File**: `.ai/hooks/worktree-guard.sh`
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block ".ai/hooks" --request "docs/architecture/requests/20260528-222705-ai-hooks-ai-hooks-worktree-guard-sh.md"`.
...
```json
{
  "ts": "2026-05-28T22:27:05+0800",
  "file_path": ".ai/hooks/worktree-guard.sh",
  "severity": "high",
  ...
  "request_file": "docs/architecture/requests/20260528-222705-ai-hooks-ai-hooks-worktree-guard-sh.md",
