# Architecture Drift Request: 20260528-154740-ai-hooks-ai-hooks-hook-input-sh
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block ".ai/hooks" --request "docs/architecture/requests/20260528-154740-ai-hooks-ai-hooks-hook-input-sh.md"`.
...
```json
{
  ...
  "request_file": "docs/architecture/requests/20260528-154740-ai-hooks-ai-hooks-hook-input-sh.md",
