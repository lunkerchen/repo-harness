# Architecture Drift Request: 20260528-222457-ai-hooks-ai-hooks-pre-edit-guard-sh

> **Status**: Pending
> **Detected**: 2026-05-28T22:24:57+0800
> **Severity**: high
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block ".ai/hooks" --request "docs/architecture/requests/20260528-222457-ai-hooks-ai-hooks-pre-edit-guard-sh.md"`.
...
```json
{
  ...
  "request_file": "docs/architecture/requests/20260528-222457-ai-hooks-ai-hooks-pre-edit-guard-sh.md",
