# Architecture Drift Request: 20260528-222416-ai-hooks-ai-hooks-hook-input-sh

> **Status**: Pending
> **Detected**: 2026-05-28T22:24:16+0800
> **Severity**: high
> **Change Type**: workflow-surface
> **File**: `.ai/hooks/hook-input.sh`
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block ".ai/hooks" --request "docs/architecture/requests/20260528-222416-ai-hooks-ai-hooks-hook-input-sh.md"`.
...
```json
{
  "ts": "2026-05-28T22:24:16+0800",
  "file_path": ".ai/hooks/hook-input.sh",
  "severity": "high",
  ...
  "request_file": "docs/architecture/requests/20260528-222416-ai-hooks-ai-hooks-hook-input-sh.md",
