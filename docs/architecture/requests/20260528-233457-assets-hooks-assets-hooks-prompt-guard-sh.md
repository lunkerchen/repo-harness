# Architecture Drift Request: 20260528-233457-assets-hooks-assets-hooks-prompt-guard-sh

> **Status**: Pending
> **Detected**: 2026-05-28T23:34:57+0800
> **Severity**: high
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block "assets/hooks" --request "docs/architecture/requests/20260528-233457-assets-hooks-assets-hooks-prompt-guard-sh.md"`.
...
```json
{
  ...
  "request_file": "docs/architecture/requests/20260528-233457-assets-hooks-assets-hooks-prompt-guard-sh.md",
