# Architecture Drift Request: 20260528-233637-ai-hooks-ai-hooks-prompt-guard-sh

> **Status**: Pending
> **Detected**: 2026-05-28T23:36:37+0800
> **Severity**: high
...
- If this starts or advances durable execution, run `scripts/workstream-sync.sh ensure --block ".ai/hooks" --request "docs/architecture/requests/20260528-233637-ai-hooks-ai-hooks-prompt-guard-sh.md"`.
...
```json
{
  ...
  "request_file": "docs/architecture/requests/20260528-233637-ai-hooks-ai-hooks-prompt-guard-sh.md",
